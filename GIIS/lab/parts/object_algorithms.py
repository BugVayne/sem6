...
class Object3DViewer(QGraphicsView):
    ...
    def draw_axes(self):
        """Draws reference axes (X, Y, Z) in the scene."""
        axis_length = 0.25  
        ...
        x_axis_end = rotation_matrix_y @ x_axis_end @ rotation_matrix_x
        y_axis_end = rotation_matrix_y @ y_axis_end @ rotation_matrix_x
        z_axis_end = rotation_matrix_y @ z_axis_end @ rotation_matrix_x

        
        origin_2d = (int(origin[0] * 400 + 400), int(-origin[1] * 300 + 300))
        x_axis_2d = (int(x_axis_end[0] * 400 + 400), int(-x_axis_end[1] * 300 + 300))
        y_axis_2d = (int(y_axis_end[0] * 400 + 400), int(-y_axis_end[1] * 300 + 300))
        z_axis_2d = (int(z_axis_end[0] * 400 + 400), int(-z_axis_end[1] * 300 + 300))

        
        self.scene.addLine(origin_2d[0], origin_2d[1], x_axis_2d[0], x_axis_2d[1],
                           QPen(QColor(255, 0, 0)))  
        self.scene.addLine(origin_2d[0], origin_2d[1], y_axis_2d[0], y_axis_2d[1],
                           QPen(QColor(0, 255, 0)))  
        self.scene.addLine(origin_2d[0], origin_2d[1], z_axis_2d[0], z_axis_2d[1],
                           QPen(QColor(0, 0, 255)))  
